/**
 *  Virtual Mode Protected Momentary Contact Switch
 *
 *  Copyright 2017 Oleg Latyshev
 *
...
metadata {
	definition (name: "Virtual Mode Protected Momentary Contact Switch", namespace: "Home", author: "Oleg Latyshev") {
		capability "Actuator"
		capability "Switch"
		capability "Refresh"
